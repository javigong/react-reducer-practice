...
var orderReducer = function orderReducer(order, action) {
  switch (action.type) {
    case "ADD_ITEM":
      {
        var clonedOrder = _toConsumableArray(order);
        ...
        if (index > -1) {
          ...
          return _toConsumableArray(clonedOrder);
        } else {
          return [].concat(_toConsumableArray(clonedOrder), [{
    ...
    case "REMOVE_ITEM":
      {
        var _clonedOrder = _toConsumableArray(order);
        ...
        _clonedOrder.splice(_index, 1);

        return _toConsumableArray(_clonedOrder);
      }

    case "MODIFY_ITEM":
      {
        var _clonedOrder2 = _toConsumableArray(order);

        var _index2 = order.findIndex(function (item) {
          return item.id === action.payload.id;
        }); // modify item


        _clonedOrder2[_index2].quantity = action.payload.quantity;
        return _toConsumableArray(_clonedOrder2);
      }
...
var App = function App(props) {
  ...
  var _useReducer = (0,react__WEBPACK_IMPORTED_MODULE_0__.useReducer)(orderReducer, initialOrder),
  ...
  var _useState3 = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(""),
      ...
      orderItemId = _useState4[0],
      setOrderItemId = _useState4[1];
  ...
  }), modal && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_OrderItemModifier_js__WEBPACK_IMPORTED_MODULE_3__["default"], {
    className: "modal",
...
var MenuItemChooser = function MenuItemChooser(props) {
  ...
  var _useState = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]),
      _useState2 = _slicedToArray(_useState, 2),
      items = _useState2[0],
      setItems = _useState2[1]; // get menu items from the API once on component mount
...
var Order = function Order(props) {
  ...
  props.order.map(function (item) {
    arrayOfPrices.push((item.price ? item.price : 0) * (item.quantity ? item.quantity : 0));
  });
  ...
  var totalPrice = arrayOfPrices.reduce(reducer);
  var totalPriceRounded = Number(Math.round(totalPrice + "e2") + "e-2");
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    className: "order"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h2", null, "Your Order"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("ul", null, props.order.map(function (item) {
    return item.id && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("li", {
      key: item.id
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h3", null, item.name), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null, "$".concat(item.price)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null, "Quantity: ".concat(item.quantity)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", {
      onClick: function onClick(event) {
        return props.handleRemoveFromOrder(event, item);
      }
    }, "Remove Item"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", {
      onClick: function onClick(event) {
        return props.handleModifyOrderItem(event, item);
      }
    }, "Modify Item"));
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h3", null, "Total:"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", null, totalPriceRounded > 1 && "$".concat(totalPriceRounded)));
};
...
var OrderItemModifier = function OrderItemModifier(props) {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", {
    ...
    onSubmit: function onSubmit(event) {
      return props.handleSubmitModification(event, props.orderItemId);
    }
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("h2", null, "Modify this Item"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", null, props.orderItemId.name), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("label", {
    htmlFor: "quantity"
    ...
    placeholder: "1",
    min: "1"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("button", null, "Done"))));
};
